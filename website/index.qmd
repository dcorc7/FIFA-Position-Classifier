...
Antonio Rüdiger represents a central defender. His card typically shows high defending and physical stats, with relatively lower pace and shooting. These traits emphasize his role in halting attacks, winning aerial duels, and maintaining defensive structure.
...
Rodrigo Hernández Cascante (Rodri) plays as a central defensive midfielder. His attributes are more balanced, with solid passing and defending stats, reflecting his dual role as both a disruptor and a deep-lying playmaker who links defense and attack.
...
Matheus Cunha is a striker, and his card emphasizes pace, dribbling, and shooting. These features highlight his primary role: creating and converting goal-scoring opportunities.
...
By comparing the front-facing visuals and detailed attribute breakdowns of these players, we can see how FIFA cards encapsulate tactical roles beyond generic positional labels. This visualization not only enhances the interpretability of the data but also helps demonstrate how player attributes inform role-specific classifications in the neural network models.
